...
export const ASPIRATION_BRIDGES: Record<string, AspirationBridge> = {
  ...
  medecine: {
    ...
    domains: ["Sciences & Ingénierie", "Communication & Leadership"],
  ...
  agriculture: {
    ...
    domains: ["Agriculture & Nature", "Sciences & Ingénierie"],
  ...
  commerce: {
    ...
    domains: ["Entrepreneuriat", "Communication & Leadership"],
  ...
  sport: {
    ...
    domains: ["Sport & Défis Physiques", "Communication & Leadership"],
