        ...
        {steps.map((step, index) => {
          ...
          return (
            <AccordionItem 
              key={index} 
              value={`step-${index}`} 
              className="border border-ink/10 bg-surface/30 rounded-xl px-4 overflow-hidden data-[state=open]:bg-white data-[state=open]:border-brand/20 data-[state=open]:shadow-sm transition-all"
            >
