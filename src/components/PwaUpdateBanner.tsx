...
export function PwaUpdateBanner() {
  ...
  return (
    <div className="fixed top-0 left-1/2 z-[60] w-full max-w-[414px] -translate-x-1/2 px-3 pt-[calc(0.75rem+env(safe-area-inset-top))] animate-in slide-in-from-top-6 duration-300">
      <div
