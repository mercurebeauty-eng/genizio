  ...
  return (
    <div className="min-h-dvh bg-surface text-ink antialiased">
      ...
      <article className="mx-auto max-w-3xl px-6 py-12 md:py-20">
        <nav aria-label="Fil d'Ariane" className="mb-8 flex flex-wrap items-center gap-1.5 text-xs font-bold text-ink/50">
        ...
        <div className="mt-12 border-t border-ink/10 pt-6">
          <Link to="/guides" className="inline-flex items-center gap-2 text-sm font-bold text-brand hover:underline">
