...
function ChallengesPage() {
  ...
  const refetch = async () => {
    ...
    try {
      ...
      // Réseau instable : sans ça, un échec de chargement s'affichait comme un
      // faux « Aucune expérience entamée » — l'utilisateur relançait une
      // génération au lieu de réessayer le chargement.
      console.error("Erreur de chargement des défis:", err);
      setError(err instanceof Error ? err.message : "Impossible de charger les défis.");
    } finally {
      setFetching(false);
