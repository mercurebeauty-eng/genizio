...
const FAQ = [
  {
    question: "Pourquoi mon enfant attend-il que je crie pour ranger sa chambre ou faire ses devoirs ?",
    answer:
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        système : des <strong>règles négociées avec lui</strong>, des <strong>tâches adaptées à son
        âge</strong> et un <strong>tableau visible</strong> qu'il coche lui-même. Quand l'enfant
        devient acteur de sa propre organisation, vous n'avez plus besoin d'être le rappel à l'ordre
        permanent.
      </p>
      ...
      <p>
        ...
        vraies questions : <em>« Qu'est-ce qui est le plus fatigant pour toi quand il faut ranger ? »</em>,{" "}
      ...
      <p>
        ...
        et quand il la conteste, vous n'avez plus à défendre votre autorité : il suffit de montrer la
        charte qu'il a signée avec vous.
      </p>

      <h2>Les tâches par âge : ce qu'un enfant peut vraiment gérer</h2>
      <p>
        Le secret d'une autonomie qui tient dans la durée : <strong>confier des tâches à sa
        mesure</strong>. Une mission trop difficile décourage, une mission trop facile ennuie. Voici
        des repères concrets, adaptés aux familles qui n'ont pas de matériel particulier :
      </p>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-ink/10">
            <tr>
              ...
              <td className="px-4 py-3">Préparer son sac de classe (avec une liste), ranger ses jouets par catégorie, mettre la table, se brosser les dents sans rappel</td>
              <td className="px-4 py-3">Une seule mission par jour, toujours la même, avec une image ou un dessin pour s'y retrouver</td>
            </tr>
            <tr>
              <td className="px-4 py-3 font-bold">8-10 ans</td>
              <td className="px-4 py-3">Ranger sa chambre de A à Z, préparer son cartable la veille, arroser les plantes, aider à préparer un repas simple</td>
              <td className="px-4 py-3">Le tableau des missions avec cases à cocher — il gère lui-même, vous vérifiez en fin de journée</td>
            </tr>
            <tr>
              <td className="px-4 py-3 font-bold">11-12 ans</td>
              <td className="px-4 py-3">Planifier son temps de devoirs, suivre une recette seul, faire de petites courses au quartier, gérer un petit budget</td>
              <td className="px-4 py-3">Il fixe lui-même ses horaires dans un cadre validé — vous lâchez prise, il s'organise</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="my-6 rounded-2xl bg-sky-50 p-5 border border-sky-200">
        ...
        <p className="text-sm text-sky-900 leading-relaxed">
          Transformez les tâches en étapes concrètes numérotées : 1. Sac de classe vérifié, 2. Tenue du lendemain préparée, 3. Bureau libéré. L'enfant peut cocher lui-même ses réussites — le tableau devient son chef, et vous n'êtes plus le rappel vivant.
        </p>
      </div>
      ...
      <div className="my-6 rounded-2xl bg-emerald-50 p-5 border border-emerald-200">
        ...
        <p className="text-sm text-emerald-900 leading-relaxed">
          Confiez-lui la responsabilité complète d'une tâche familiale : planifier les ingrédients du repas du samedi, calculer les sommes nécessaires et vous accompagner au marché. Une responsabilité confiée pour de vrai responsabilise — on se sent concerné quand on décide, pas quand on exécute.
        </p>
      </div>

      <h2>Que faire en cas d'oubli ou de refus ?</h2>
      <ul>
        <li><strong>Appliquer les conséquences naturelles :</strong> S'il oublie son cahier malgré son tableau de mission, laissez l'école lui en faire le rappel plutôt que de dramatiser à la maison. La conséquence naturelle enseigne mieux que n'importe quel sermon.</li>
        <li><strong>Remplacer le reproche par l'analyse :</strong> <em>"Qu'est-ce qui a manqué dans ton organisation hier pour que tu sois en retard ce matin ?"</em> La question ouvre une solution ; l'accusation ferme la discussion.</li>
        <li><strong>Revenir à la charte, pas à la voix :</strong> Si l'enfant conteste une règle, montrez l'accord affiché qu'il a contribué à écrire. Il ne se bat plus contre vous, mais contre sa propre signature.</li>
        <li><strong>Célébrer la régularité :</strong> Validez ses réussites dans son cahier des réussites (tableau, photos de ses rangements réussis). La fierté visible nourrit la motivation bien mieux que les rappels.</li>
      </ul>
