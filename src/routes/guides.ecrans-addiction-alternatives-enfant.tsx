  ...
  head: () => {
    ...
    return {
      ...
      scripts: [
        ...
        jsonLdScript(
          articleJsonLd({
            headline: "Mon enfant est accro aux écrans : comment réduire le temps d'écran en douceur, sans crise",
            description:
...
function Guide() {
  return (
    ...
    >
      ...
      <p>
        Quand vous éteignez brusquement la tablette, l'enfant passe d'un état de <strong>sur-stimulation</strong> à un vide total. D'où la crise, les pleurs, la négociation interminable. Ce n'est pas de la mauvaise volonté — c'est une réaction normale de son système nerveux. Et ce qui est retiré d'un coup est souvent repris en cachette quelques jours plus tard : c'est le <strong>phénomène du yoyo</strong>, qui épuise les parents et fait perdre confiance à l'enfant.
      </p>
      <p>
        La solution n'est ni d'interdire, ni de laisser faire, mais de <strong>changer progressivement</strong>. C'est exactement le principe du sevrage en élevage : on ne retire jamais le lait d'un coup à un jeune animal — on remplace petit à petit, 10 % d'aliment dur et le reste de lait, puis un peu plus chaque semaine, jusqu'à l'équilibre. On fait pareil avec les écrans, pour ne pas mettre l'organisme de l'enfant à rude épreuve.
      </p>

      <h2>Parler avec son enfant avant de toucher aux écrans</h2>
      <p>
        Avant de changer quoi que ce soit, il faut <strong>discuter</strong>. Beaucoup de parents annoncent une décision (« à partir de demain, une heure par jour ! ») et se heurtent à un mur. L'enfant ne se braque pas parce qu'il est « accro » : il se braque parce qu'on touche à quelque chose qu'il aime, sans lui demander son avis.
      </p>
      <p>
        Posez-lui de vraies questions, sans jugement et sans sermon :
      </p>
      <ul>
        <li><strong>« Qu'est-ce que tu aimes le plus quand tu joues ? »</strong> — la réponse révèle ce qu'il faut remplacer : le défi, la construction, l'histoire, l'action…</li>
        <li><strong>« Avec qui tu joues ? »</strong> — si l'écran remplace des copains, l'activité de remplacement devra être sociale ; si c'est un refuge, elle devra être rassurante.</li>
        <li><strong>« Qu'est-ce que tu ressens quand on éteint ? »</strong> — l'enfant qui met des mots sur sa frustration comprend mieux pourquoi vous voulez changer les choses.</li>
      </ul>
      <p>
        Ensuite, <strong>négociez l'accord ensemble</strong>. Laissez l'enfant proposer d'abord : quelle activité remplacerait tel jeu, à quel moment il éteint lui-même, quelle récompense de confiance il gagne (choisir le repas du dimanche, une sortie…). Vous validez, vous écrivez l'accord, vous l'affichez. Un enfant s'engage dix fois mieux dans une règle qu'il a contribué à construire — et la discussion que vous ouvrez aujourd'hui est le socle de tous les changements qui suivent.
      </p>

      <h2>Le changement progressif : le sevrage en douceur, palier par palier</h2>
      <p>
        Une fois l'accord trouvé, on ne réduit pas tout d'un coup : on descend <strong>par paliers d'environ 10 % par semaine</strong>. Si votre enfant passe 2 heures par jour sur les écrans, cela donne un sevrage en douceur sur 4 à 6 semaines :
      </p>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-ink/10">
            ...
            <tr>
              ...
              <td className="px-4 py-3">Consolidation : l'accord reste affiché, on fête la régularité</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p>
        Le rythme importe plus que la quantité : tant que l'enfant encaisse bien un palier (pas de crise majeure, pas de repli), on descend au palier suivant. S'il régresse, on reste une semaine de plus au même niveau. <strong>La régularité compte plus que la vitesse</strong> — c'est elle qui transforme l'habitude, pas la fermeté d'un jour.
      </p>
      <p>
        À chaque palier, le temps retiré est <strong>remplacé</strong>, jamais laissé vide. C'est ce qu'on appelle le <strong>sevrage par le faire</strong> : on ne retire pas l'écran, on le rend inutile. Voici trois activités de remplacement qui fonctionnent particulièrement bien pour les 6-12 ans.
      </p>
      ...
      <ul>
        ...
        <li><strong>Valoriser ce qui est fait sans écran :</strong> Exposez les créations de votre enfant dans le salon, photographiez-les pour un « cahier de famille ». Quand l'effort réel est reconnu publiquement, l'envie de créer l'emporte progressivement sur l'envie de scroller.</li>
        ...
        <li><strong>Fêter chaque palier :</strong> À la fin de chaque semaine de sevrage tenue, marquez le coup avec l'enfant (sortie, plat qu'il choisit, visite). Le changement progressif devient alors une aventure commune, pas une privation.</li>
      </ul>
