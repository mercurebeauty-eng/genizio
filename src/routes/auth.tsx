  ...
  return (
    <div className="min-h-screen bg-surface px-6 py-16 text-ink">
      <div className="mx-auto max-w-md">
        ...
        <div className="rounded-3xl border-[3px] border-ink bg-white p-8 shadow-brutal">
          ...
          <button
            ...
            onClick={google}
            disabled={busy}
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-2xl border-[3px] border-ink bg-white px-4 py-3 text-sm font-bold shadow-brutal-sm transition-all hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-60"
          >
