...
Portée volontairement restreinte à 3 domaines "académiques" au sens scolaire du terme
(mathématiques/logique, langage, sciences/monde). Les 6 autres intelligences Gardner
(spatiale, corporelle, sociale, entrepreneuriale, créative, artisanale, émotionnelle) ne sont
**pas** couvertes ici — ce ne sont pas des connaissances curriculaires comparables à l'échelle
