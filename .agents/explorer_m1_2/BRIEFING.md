...
- Design structured academic curriculum registry for grades CP to 3ème covering main subjects (Maths, Français, Sciences, Histoire-Géo) with sample topics and gap detection hooks
- Design Bayesian ZPA telemetry adjustment algorithm modulating homework challenge difficulty (levels 1-5) without causing performance anxiety
...
- **Key findings**:
  - TBD
- **Unexplored areas**:
  - Data models (child profile, grade levels, interest/driver data)
  - Telemetry & Bayesian progression tracking (`naya-telemetry.ts`, `hypothesis_cycles`)
  - Curriculum registry architecture (CP to 3ème)
...
- analysis.md — Comprehensive findings & designs (to be generated)
