...
- **Key findings**:
  ...
  - Identified key gaps for academic fusion: lack of explicit homework instruction input, formal grade levels (CP-3ème), curriculum topic catalog, and explicit behavioral driver selection (_déconstruire_, _schématiser_, _simuler_, _enquêter_, _optimiser_).
